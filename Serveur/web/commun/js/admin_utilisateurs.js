...
function raffraichirTable( debut ) {
	...
	while( i < liste_utilisateurs.length ) {
		...
		tbody += '<td>' + liste_utilisateurs[i].nom + '</td>';
		tbody += '<td>' + liste_utilisateurs[i].prenom + '</td>';

		/* Les actions, à savoir Voir, Editer, Bannir */
		tbody += '<td style="text-align: center;">';
		tbody += '<a href="#admin_user_dialog" data-toggle="modal"><i class="icon-pencil"></i></a> ';
		tbody += '<a href="#admin_user_dialog" data-toggle="modal"><i class="icon-remove"></i></a>';
		tbody += '</td>';
		tbody += '</tr>';
