...
<div id="contact" class="row" style="margin-top: 20px;">
    <div class="span6 columns">
        <div>
            ...
            <li>Relations avec les Entreprises : aedi.entreprise.asso</li>
            <li>Animations : /</li>
            <li>Communication : /</li>
            </ul>
        </div>
    ...
    <div class="span4 columns">
        <img src="http://www.tumblr.com/photo/1280/bonjourlesifs/10800337619/1/tumblr_ls6yl1PbAi1qbvwm2" width="530px" alt="Conf&eacute;rence AEDI">
    </div>
