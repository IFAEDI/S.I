				...
				<div class="tab-content">
					<div class="tab-pane active" id="about-asso">
						<div class="hero-unit">
							...
							Chaque année, une équipe d'étudiants volontaires est élue pour reprendre sa tête, apportant ainsi de nouvelles pierres à l'édifice.</p>
						</div>
						<div style="position:relative;">
							<h2 class="bleuBur"><i class="icon icon-star icon-white"></i> Notre Mission</h2>
							<p class="justify">L'AEDI a pour rôle de <span class="hero_motcle">renforcer la cohésion entre les étudiants du Département Informatique, les aider dans leur cursus, et établir des contacts privilégiés avec les entreprises</span>.
							Pour cela, l'AEDI profite aujourd'hui d'un riche reseau construit au cours des ans, regroupant anciens élèves investis, entreprises clés du monde informatique, et enseignants motivés. Ces ressources, mises à disposition à travers de nombreux évènements fédérateurs, comme les <a title="En savoir plus sur les RIF" href="index.php?page=RIFs_Entreprise">Rencontre IF</a> ou les <a title="En savoir plus sur les conférences" href="index.php?page=Conferences">conférences</a>, offrent des opportunités en or aux étudiants de découvrir les acteurs de l'Informatique, et leur futur employeur. Réciproquement, cela permet aux entreprises de renforcer leur présence et découvrir des profils intéressants.<br/>
							S'il est primordial pour les élèves de profiter de ces occasions et de se projeter dans le futur, L'AEDI a aussi conscience de l'importance, parfois, de simplement profiter du présent, de ces années étudiantes qui passent bien trop vite. Dans cette optique sont régulierement organisés des évènements récréatifs. Intégration des nouveaux venus, sorties en ville, goûters, activités sportives, ... Toutes les occasions sont bonnes pour renforcer les liens au sein du Département, mais aussi avec l'exterieur, grâce aux bonnes relations développées avec d'autres associations étudiantes lyonnaises.<br/>
							L'AEDI s'est donc donnée comme vocation d'être un <span class="hero_motcle">acteur clé</span> du Département, en aidant les étudiants dans tous les aspects de leurs etudes.</p>
							
							<h2 class="bleuEntr" ><i class="icon icon-heart icon-white"></i> Nos Valeurs</h2>
							<p class="justify">L'AEDI a fait le voeu de croire profondément dans le potentiel des étudiants du Département Informatique. C'est pourquoi nous nous efforcons d'apporter le terreau, les opportunités, destinés à faire valoir ces talents. La diversité des profils au sein des promotions est également une caracteristique que nous chérissons et encourageons, afin de favoriser une atmosphere d'échanges et de camaraderie plûtot que de compétition.<br/>
							Enfin, pur produit de l'esprit associatif de l'INSA-Lyon, l'AEDI a à coeur de faire prospérer celui-ci, en encourageant les initiatives étudiantes et les partenariats inter- et extra-campus.</p>
>>>>>>> <Contenu> A propos - 1er jet
						</div>
					</div>
